...
val ACTIONTABLE: Int => Int => Action = {
  ...
  case 6 => { case 20 => SHIFT(7);  case _ => REDUCE(37,2,0);  }
  case 7 => { case 3 => SHIFT(9);  case _ => ERROR;  }
  case 8 => { case 33 => SHIFT(10);  case 34 => SHIFT(11);  case _ => REDUCE(39,8,0);  }
  case 9 => { case _ => REDUCE(37,3,2);  }
  case 10 => { case 3 => SHIFT(13);  case _ => ERROR;  }
  case 11 => { case 3 => SHIFT(14);  case _ => ERROR;  }
  case 12 => { case 32 => SHIFT(15);  case _ => REDUCE(44,20,0);  }
  case 13 => { case 34 => SHIFT(17);  case _ => ERROR;  }
  case 14 => { case 33 => SHIFT(18);  case _ => ERROR;  }
  case 15 => { case 3 => SHIFT(19);  case _ => ERROR;  }
  case 16 => { case 30 => SHIFT(20);  case _ => REDUCE(38,4,0);  }
  case 17 => { case 3 => SHIFT(22);  case _ => ERROR;  }
  case 18 => { case 3 => SHIFT(23);  case _ => ERROR;  }
  case 19 => { case _ => REDUCE(44,21,2);  }
  case 20 => { case 5 => SHIFT(24);  case _ => ERROR;  }
  case 21 => { case 25 => SHIFT(25);  case 26 => SHIFT(26);  case 27 => SHIFT(27);  case 28 => SHIFT(28);  case _ => REDUCE(40,9,0);  }
  case 22 => { case _ => REDUCE(39,6,4);  }
  case 23 => { case _ => REDUCE(39,7,4);  }
  case 24 => { case _ => REDUCE(38,5,2);  }
  ...
  case 30 => { case 25 => SHIFT(25);  case 26 => SHIFT(26);  case 27 => SHIFT(27);  case 28 => SHIFT(28);  case _ => REDUCE(40,9,0);  }
  case 31 => { case 13 => SHIFT(39);  case 16 => SHIFT(40);  case _ => REDUCE(43,19,1);  }
  case 32 => { case _ => REDUCE(41,14,2);  }
  case 33 => { case 3 => SHIFT(31);  case _ => REDUCE(42,15,1);  }
  case 34 => { case _ => REDUCE(41,11,2);  }
  case 35 => { case _ => REDUCE(41,12,2);  }
  case 36 => { case _ => REDUCE(41,13,2);  }
  case 37 => { case 30 => SHIFT(20);  case _ => REDUCE(38,4,0);  }
  case 38 => { case _ => REDUCE(40,10,2);  }
  case 39 => { case 3 => SHIFT(43);  case 16 => SHIFT(44);  case _ => ERROR;  }
  case 40 => { case 3 => SHIFT(43);  case 16 => SHIFT(44);  case _ => ERROR;  }
  case 41 => { case _ => REDUCE(42,16,2);  }
  case 42 => { case 3 => SHIFT(47);  case _ => ERROR;  }
  case 43 => { case 8 => SHIFT(51);  case _ => REDUCE(55,41,1);  }
  case 44 => { case 3 => SHIFT(43);  case 16 => SHIFT(44);  case 17 => SHIFT(52);  case _ => ERROR;  }
  case 45 => { case _ => REDUCE(43,17,3);  }
  case 46 => { case 17 => SHIFT(55);  case _ => ERROR;  }
  case 47 => { case 13 => SHIFT(56);  case _ => REDUCE(48,28,1);  }
  case 48 => { case 10 => SHIFT(57);  case _ => REDUCE(47,25,0);  }
  case 49 => { case _ => REDUCE(45,22,1);  }
  case 50 => { case 11 => SHIFT(59);  case _ => ERROR;  }
  case 51 => { case 3 => SHIFT(43);  case 16 => SHIFT(44);  case _ => ERROR;  }
  case 52 => { case _ => REDUCE(55,44,2);  }
  case 53 => { case 18 => SHIFT(61);  case _ => REDUCE(56,45,1);  }
  case 54 => { case 17 => SHIFT(62);  case _ => ERROR;  }
  case 55 => { case _ => REDUCE(43,18,4);  }
  case 56 => { case 3 => SHIFT(43);  case 16 => SHIFT(44);  case _ => ERROR;  }
  case 57 => { case 3 => SHIFT(47);  case _ => REDUCE(47,26,1);  }
  case 58 => { case _ => REDUCE(36,1,13);  }
  ...
  case 62 => { case _ => REDUCE(55,43,3);  }
  case 63 => { case _ => REDUCE(48,27,3);  }
  case 64 => { case _ => REDUCE(45,23,3);  }
  case 65 => { case 13 => SHIFT(73);  case _ => REDUCE(52,35,1);  }
  case 66 => { case _ => REDUCE(51,32,1);  }
  case 67 => { case _ => REDUCE(46,24,3);  }
  case 68 => { case 12 => SHIFT(74);  case _ => REDUCE(49,29,1);  }
  case 69 => { case 5 => SHIFT(75);  case _ => REDUCE(53,37,0);  }
  case 70 => { case 3 => SHIFT(65);  case 22 => SHIFT(66);  case _ => REDUCE(51,33,1);  }
  case 71 => { case _ => REDUCE(55,42,4);  }
  case 72 => { case _ => REDUCE(56,46,3);  }
  case 73 => { case 3 => SHIFT(78);  case _ => ERROR;  }
  case 74 => { case 3 => SHIFT(65);  case 22 => SHIFT(66);  case _ => ERROR;  }
  case 75 => { case _ => REDUCE(53,38,1);  }
  case 76 => { case 31 => SHIFT(80);  case _ => REDUCE(54,39,0);  }
  case 77 => { case _ => REDUCE(51,34,2);  }
  case 78 => { case _ => REDUCE(52,36,3);  }
  case 79 => { case _ => REDUCE(49,30,3);  }
  case 80 => { case 3 => SHIFT(82);  case _ => ERROR;  }
  case 81 => { case _ => REDUCE(50,31,3);  }
  case 82 => { case _ => REDUCE(54,40,2);  }
  case _ => { case _ => ERROR }
  }
}
