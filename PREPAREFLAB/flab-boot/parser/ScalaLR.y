...
%%
command:  Notation;
Notation:  TOK-23 ID TOK-24 ID TOK-20 ID OptDialects Tables OptInclude Tokens TOK-29 OptInclude Rules OptSemicolon;
OptInclude: ;
OptInclude:  TOK-30 CODE;
OptDialects:  TOK-33 ID TOK-34 ID;
OptDialects:  TOK-34 ID TOK-33 ID;
OptDialects: ;
Tokens: ;
