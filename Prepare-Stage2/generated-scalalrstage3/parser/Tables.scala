...
val goto: Int => Int => Int = {
  ...
  case 61 => { case 48 => 68;  case 49 => 69;  case 50 => 70;  case 51 => 71;  case 52 => 72;  case 64 => 73;  case 65 => 74;  }
...
val action: Int => Int => Action = {
  ...
  case 7 => { case 3 => SHIFT(20);  case _ => REDUCE(61,54,2);  }
  case 8 => { case 3 => SHIFT(20);  case _ => REDUCE(61,54,2);  }
  case 9 => { case 3 => SHIFT(20);  case _ => REDUCE(61,54,2);  }
  case 10 => { case 3 => SHIFT(20);  case _ => REDUCE(61,54,2);  }
  ...
  case 22 => { case _ => REDUCE(60,51,0);  }
  case 23 => { case 3 => SHIFT(20);  case _ => REDUCE(61,53,1);  }
  ...
  case 37 => { case _ => REDUCE(60,52,1);  }
  case 38 => { case 19 => SHIFT(48);  case _ => ERROR;  }
  case 39 => { case 13 => SHIFT(49);  case _ => REDUCE(46,23,0);  }
  case 40 => { case _ => REDUCE(57,46,1);  }
  case 41 => { case 11 => SHIFT(50);  case _ => ERROR;  }
  case 42 => { case 3 => SHIFT(39);  case _ => REDUCE(58,48,1);  }
  case 43 => { case 19 => SHIFT(52);  case _ => REDUCE(58,49,2);  }
  case 44 => { case 8 => SHIFT(54);  case _ => REDUCE(55,40,0);  }
  ...
  case 50 => { case 12 => SHIFT(60);  case _ => REDUCE(62,55,1);  }
  case 51 => { case _ => REDUCE(57,47,3);  }
  case 52 => { case _ => REDUCE(59,50,1);  }
  case 53 => { case _ => REDUCE(40,1,5);  }
  case 54 => { case 3 => SHIFT(44);  case 16 => SHIFT(45);  case _ => ERROR;  }
  case 55 => { case _ => REDUCE(56,43,4);  }
  case 56 => { case 18 => SHIFT(63);  case _ => REDUCE(56,44,3);  }
  case 57 => { case 17 => SHIFT(64);  case _ => ERROR;  }
  case 58 => { case _ => REDUCE(44,19,4);  }
  case 59 => { case _ => REDUCE(46,22,1);  }
  case 60 => { case _ => REDUCE(62,56,0);  }
  ...
  case 64 => { case _ => REDUCE(56,42,1);  }
  case 65 => { case 13 => SHIFT(77);  case _ => REDUCE(51,31,1);  }
  case 66 => { case 3 => SHIFT(65);  case 16 => SHIFT(66);  case 22 => SHIFT(67);  case _ => ERROR;  }
  case 67 => { case _ => REDUCE(48,26,1);  }
  case 68 => { case _ => REDUCE(45,21,4);  }
  case 69 => { case _ => REDUCE(63,57,0);  }
  case 70 => { case 5 => SHIFT(79);  case _ => REDUCE(53,36,1);  }
  case 71 => { case 3 => SHIFT(65);  case 16 => SHIFT(66);  case 22 => SHIFT(67);  case _ => REDUCE(49,27,3);  }
  case 72 => { case _ => REDUCE(50,29,1);  }
  case 73 => { case 12 => SHIFT(82);  case _ => REDUCE(64,59,1);  }
  case 74 => { case _ => REDUCE(47,24,3);  }
  case 75 => { case _ => REDUCE(55,41,2);  }
  case 76 => { case _ => REDUCE(56,45,2);  }
  case 77 => { case 3 => SHIFT(83);  case 16 => SHIFT(66);  case _ => ERROR;  }
  case 78 => { case 17 => SHIFT(85);  case _ => ERROR;  }
  case 79 => { case _ => REDUCE(53,37,1);  }
  case 80 => { case 31 => SHIFT(86);  case _ => REDUCE(54,38,0);  }
  case 81 => { case _ => REDUCE(50,28,1);  }
  case 82 => { case 3 => SHIFT(65);  case 16 => SHIFT(66);  case 22 => SHIFT(67);  case _ => ERROR;  }
  case 83 => { case _ => REDUCE(51,31,1);  }
  case 84 => { case _ => REDUCE(50,30,2);  }
  case 85 => { case 36 => SHIFT(89);  case 37 => SHIFT(90);  case 38 => SHIFT(91);  case _ => ERROR;  }
  case 86 => { case 3 => SHIFT(93);  case _ => ERROR;  }
  case 87 => { case _ => REDUCE(47,25,1);  }
  case 88 => { case _ => REDUCE(63,58,1);  }
  case 89 => { case _ => REDUCE(52,33,1);  }
  case 90 => { case _ => REDUCE(52,34,4);  }
  case 91 => { case _ => REDUCE(53,35,1);  }
  case 92 => { case _ => REDUCE(51,32,3);  }
  case 93 => { case _ => REDUCE(54,39,1);  }
  case _ => { case _ => ERROR }
  }
}
