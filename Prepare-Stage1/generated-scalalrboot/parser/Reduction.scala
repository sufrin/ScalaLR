...
def parsetreereduction(dol$START:  org.sufrin.scalalr.SourceLocation, dol$END:  org.sufrin.scalalr.SourceLocation, n: Int): PartialFunction[List[Any], Any] = n match {
 ...
 case 4 => 
  { case trees$trees => PARSETREE("""OptPath: String = "%path" ID { $ID.toPathString }""", 4, trees$trees ) }
 case 5 => 
 ...
 case 7 => 
  { case trees$trees => PARSETREE("""OptDialects: (String,String) = "%dialect" l: ID "%scalalr" r: ID { ($l, $r) }""", 7, trees$trees ) }
 case 8 => 
  { case trees$trees => PARSETREE("""OptDialects: (String,String) = "%scalalr" l: ID "%dialect" r: ID { ($r, $l) }""", 8, trees$trees ) }
 case 9 => 
  { case trees$trees => PARSETREE("""OptDialects: (String,String) =  { ("", "") }""", 9, trees$trees ) }
 case 10 => 
