...
val GOTOTABLE: Int => Int => Int = {
  ...
  case 81 => { case 67 => 93;  case 70 => 94;  case 71 => 95;  }
  case 82 => { case 63 => 97;  }
  case 86 => { case 62 => 102;  }
  case 91 => { case 67 => 103;  case 68 => 104;  case 69 => 105;  case 70 => 94;  case 71 => 95;  }
  case 107 => { case 67 => 118;  case 70 => 94;  case 71 => 95;  }
  case 108 => { case 67 => 119;  case 70 => 94;  case 71 => 95;  }
  case 109 => { case 67 => 120;  case 70 => 94;  case 71 => 95;  }
  case 110 => { case 67 => 103;  case 68 => 121;  case 69 => 105;  case 70 => 94;  case 71 => 95;  }
  case 111 => { case 71 => 122;  }
  case 117 => { case 67 => 126;  case 70 => 94;  case 71 => 95;  }
  case 128 => { case 67 => 103;  case 68 => 129;  case 69 => 105;  case 70 => 94;  case 71 => 95;  }
...
val ACTIONTABLE: Int => Int => Action = {
  ...
  case 81 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => ERROR;  }
  ...
  case 88 => { case _ => REDUCE(71,77,1);  }
  case 89 => { case _ => REDUCE(70,74,1);  }
  case 90 => { case _ => REDUCE(70,75,1);  }
  case 91 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => REDUCE(68,69,0);  }
  case 92 => { case 3 => SHIFT(106);  case _ => ERROR;  }
  case 93 => { case 40 => SHIFT(107);  case 41 => SHIFT(108);  case 42 => SHIFT(109);  case _ => REDUCE(66,61,2);  }
  case 94 => { case _ => REDUCE(67,62,1);  }
  case 95 => { case 17 => SHIFT(110);  case 43 => SHIFT(111);  case _ => REDUCE(70,73,1);  }
  case 96 => { case 3 => SHIFT(112);  case _ => ERROR;  }
  case 97 => { case _ => REDUCE(58,36,3);  }
  case 98 => { case 43 => SHIFT(113);  case _ => REDUCE(62,46,1);  }
  case 99 => { case _ => REDUCE(62,45,1);  }
  case 100 => { case 43 => SHIFT(114);  case _ => REDUCE(62,47,1);  }
  case 101 => { case 43 => SHIFT(115);  case _ => ERROR;  }
  case 102 => { case _ => REDUCE(61,44,4);  }
  case 103 => { case 40 => SHIFT(107);  case 41 => SHIFT(108);  case 42 => SHIFT(109);  case _ => REDUCE(69,72,1);  }
  case 104 => { case 18 => SHIFT(116);  case _ => ERROR;  }
  case 105 => { case 19 => SHIFT(117);  case _ => REDUCE(68,70,1);  }
  case 106 => { case _ => REDUCE(71,78,2);  }
  case 107 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => ERROR;  }
  case 108 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => ERROR;  }
  case 109 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => ERROR;  }
  case 110 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => REDUCE(68,69,0);  }
  case 111 => { case 3 => SHIFT(88);  case 44 => SHIFT(92);  case _ => ERROR;  }
  case 112 => { case _ => REDUCE(63,52,2);  }
  case 113 => { case 43 => SHIFT(123);  case _ => ERROR;  }
  case 114 => { case 43 => SHIFT(124);  case _ => ERROR;  }
  case 115 => { case 43 => SHIFT(125);  case _ => ERROR;  }
  case 116 => { case _ => REDUCE(70,76,3);  }
  case 117 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => ERROR;  }
  case 118 => { case 40 => SHIFT(107);  case 41 => SHIFT(108);  case 42 => SHIFT(109);  case _ => REDUCE(67,66,3);  }
  case 119 => { case _ => REDUCE(67,67,3);  }
  case 120 => { case _ => REDUCE(67,68,3);  }
  case 121 => { case 18 => SHIFT(127);  case _ => ERROR;  }
  case 122 => { case 17 => SHIFT(128);  case _ => REDUCE(67,65,3);  }
  case 123 => { case _ => REDUCE(62,48,3);  }
  case 124 => { case _ => REDUCE(62,49,3);  }
  case 125 => { case _ => REDUCE(62,50,3);  }
  case 126 => { case 40 => SHIFT(107);  case 41 => SHIFT(108);  case 42 => SHIFT(109);  case _ => REDUCE(69,71,3);  }
  case 127 => { case _ => REDUCE(67,63,4);  }
  case 128 => { case 3 => SHIFT(88);  case 4 => SHIFT(89);  case 6 => SHIFT(90);  case 17 => SHIFT(91);  case 44 => SHIFT(92);  case _ => REDUCE(68,69,0);  }
  case 129 => { case 18 => SHIFT(130);  case _ => ERROR;  }
  case 130 => { case _ => REDUCE(67,64,6);  }
  case _ => { case _ => ERROR }
  }
}
