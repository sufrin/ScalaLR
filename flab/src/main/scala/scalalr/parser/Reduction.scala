...
def reduction(dol$START:  org.sufrin.scalalr.SourceLocation, dol$END:  org.sufrin.scalalr.SourceLocation, n: Int): PartialFunction[List[Any], Any] = n match {
 ...
 case 2 => 
  { case List(_, dol$theName: String, _, dol$thePackage: String, _, dol$thePath: String, dol$OptDialects: (String,String), dol$Tables: String, dol$tokensInclude: String, dol$Tokens: List[TokenSpec @unchecked], _, dol$rulesInclude: String, dol$Rules: List[Rule @unchecked], dol$OptSemicolon: Unit) => 
...
def parsetreereduction(dol$START:  org.sufrin.scalalr.SourceLocation, dol$END:  org.sufrin.scalalr.SourceLocation, n: Int): PartialFunction[List[Any], Any] = n match {
 ...
 case 5 => 
  { case trees$trees => PARSETREE("""OptDialects: (String,String) = "%dialect" l: ID "%scalalr" r: ID { ($l, $r) }""", 5, trees$trees ) }
 case 6 => 
  { case trees$trees => PARSETREE("""OptDialects: (String,String) = "%scalalr" l: ID "%dialect" r: ID { ($r, $l) }""", 6, trees$trees ) }
 case 7 => 
  { case trees$trees => PARSETREE("""OptDialects: (String,String) =  { ("", "") }""", 7, trees$trees ) }
 case 8 => 
