...
val goto: Int => Int => Int = {
  ...
  case 77 => { case 65 => 89;  case 68 => 90;  }
  case 79 => { case 61 => 92;  }
  case 83 => { case 60 => 97;  }
  case 88 => { case 65 => 99;  case 68 => 90;  }
...
val action: Int => Int => Action = {
  ...
  case 69 => { case 42 => SHIFT(77);  case 5 => SHIFT(78);  case _ => REDUCE(64,56,0);  }
  ...
  case 77 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
  case 78 => { case _ => REDUCE(64,57,1);  }
  ...
  case 85 => { case 3 => SHIFT(98);  case _ => ERROR;  }
  case 86 => { case _ => REDUCE(68,69,1);  }
  case 87 => { case _ => REDUCE(68,71,1);  }
  case 88 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
  ...
  case 98 => { case _ => REDUCE(68,70,2);  }
  case 99 => { case 17 => SHIFT(109);  case 38 => SHIFT(100);  case 39 => SHIFT(101);  case 40 => SHIFT(102);  case 41 => SHIFT(103);  case _ => ERROR;  }
  case 100 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
  case 101 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
  case 102 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
  case 103 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
  case 104 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => REDUCE(66,65,0);  }
  ...
  case 121 => { case 43 => SHIFT(85);  case 3 => SHIFT(86);  case 4 => SHIFT(87);  case 16 => SHIFT(88);  case _ => ERROR;  }
