...
val action: Int => Int => Action = {
  ...
  case 11 => { case 7 => SHIFT(6);  case 0 => REDUCE(9,5,6);  case _ => ERROR;  }
  ...
  case 33 => { case 7 => SHIFT(14);  case 4 => REDUCE(9,5,6);  case _ => ERROR;  }
  case 34 => { case 4 => REDUCE(9,2,3);  case 5 => REDUCE(9,2,3);  case 7 => REDUCE(9,2,3);  case _ => ERROR;  }
  case 35 => { case 7 => SHIFT(17);  case 0 => REDUCE(9,5,6);  case 5 => REDUCE(9,5,6);  case _ => ERROR;  }
  ...
  case 38 => { case 7 => SHIFT(30);  case 4 => REDUCE(9,5,6);  case 5 => REDUCE(9,5,6);  case _ => ERROR;  }
  case _ => { case _ => ERROR }
  }
}
