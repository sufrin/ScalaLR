...
val action: Int => Int => Action = {
  ...
  case 8 => { case 0 => REDUCE(9,2,3);  case 4 => REDUCE(9,2,3);  case 5 => REDUCE(9,2,3);  case 7 => REDUCE(9,2,3);  case _ => REDUCE(9,2,3);  }
  case 9 => { case 5 => SHIFT(10);  case 7 => SHIFT(6);  case _ => REDUCE(9,6,4);  }
  case 10 => { case 3 => SHIFT(1);  case 6 => SHIFT(2);  case _ => ERROR;  }
  case 11 => { case 7 => SHIFT(6);  case _ => REDUCE(9,7,6);  }
  case _ => { case _ => ERROR }
  }
}
