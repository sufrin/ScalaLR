...
object Syntax {
  ...
  object Lexical {
    ...
    case object SCALALR             extends Atom
    case object DIALECT            extends Atom
            ...
            case '/' =>
              ...
              theChar match {
                ...
                case '/' =>
                  chars.dropWhile( c=>c!='\n')
                case other =>
                  Parser.warn(s"Malformed comment sentinel: \"/$other\" at $sourceLocation")
                  chars.dropWhile( c=>c!='\n')
              }
              next()
            case '{' =>
  ...
  object Parser extends SourceLoggable {
    ...
    class Parser(scanner: Lexical.Scanner) {
      ...
      def parseNotation(): Notation = {
        ...
        var traitName = "Token"
        var theScalalrDialect = ""
        var theNotationDialect = ""
        var tokensInclude = ""
        var explicitPath = ""
        var go = true
        while (go) {
    ...
    (thePackageName: String,
     ...
     theScalalrDialect: String = "",
     theNotationDialect: String = ""
    )
