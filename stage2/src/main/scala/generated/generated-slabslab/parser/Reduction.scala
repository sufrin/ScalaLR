...
def parsetreereduction(dol$START:  org.sufrin.scalalr.SourceLocation, dol$END:  org.sufrin.scalalr.SourceLocation, n: Int): PartialFunction[List[Any], Any] = n match {
 ...
 case 10 => 
  { case trees$trees => PARSETREE("""OptDialects: Tuple2[String,String] = "%dialect" l: ID "%scalalr" r: ID {  ($l, $r) }""", 10, trees$trees ) }
 case 11 => 
  { case trees$trees => PARSETREE("""OptDialects: Tuple2[String,String] = "%scalalr" l: ID "%dialect" r: ID {  ($r, $l) }""", 11, trees$trees ) }
 case 12 => 
  { case trees$trees => PARSETREE("""OptDialects: Tuple2[String,String] =  {  ("", "") }""", 12, trees$trees ) }
 case 13 => 
